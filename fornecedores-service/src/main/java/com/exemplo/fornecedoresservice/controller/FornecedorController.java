...
public class FornecedorController {
     ...
     * Declarado antes de /{id} por clareza: o Spring ja da preferencia ao
     * caminho literal, entao "produtos" nunca cai no metodo de busca por id.
     */
    @GetMapping("/produtos")
    ...
    /**
     * Mesmo tratamento de 404 usado no ProdutoController do produtos-service.
     */
    @GetMapping("/{id}")
